...
def remove_duplicated(dataverse_path, rededuplicated_json, old_anno_str='*new_anno_0306.json', new_anno_name='revised_anno.json'):
    anno_path = dataverse_path / 'annotations'
...
if __name__ == '__main__':
    ...
    remove_duplicated(pathlib.Path(dataverse_path), rededuplicated_json)