...
DATAVERSE_BBOX_GOV_PROJECT_ID_202505 = 431
DATAVERSE_BBOX_GOV_PROJECT_ID_202506 = 399
DATAVERSE_BBOX_GOV_PROJECT_ID_202507_1 = 697
DATAVERSE_BBOX_GOV_PROJECT_ID_202507_2 = 695
DATAVERSE_BBOX_GOV_PROJECT_ID_202507_3 = 696
DATAVERSE_BBOX_GOV_PROJECT_ID_202508_1 = 698
DATAVERSE_BBOX_GOV_PROJECT_ID_202508_2 = 699
DATAVERSE_BBOX_GOV_PROJECT_ID_202508_3 = 700
...
AUGMENTED_CURATED_EXCLUDED_JSONS = {
    ...
    "Taiwan_Power/20250610/Taiwan_Power_20250610_image_list_keep_0.95_updated.json",
    "Taiwan_Power/20250106/Taiwan_Power_20250106_image_list_keep_0.95_updated.json",
}
...
AUGMENTED_CURATED_JSONS_0731 = {
    "Transportation/20250729/Transportation_20250729_image_list_keep_0.95.json",
}
AUGMENTED_CURATED_JSONS_0731 = {pathlib.Path(f"{DATA_CURATION_ROOT}/{x}") for x in AUGMENTED_CURATED_JSONS_0731}
AUGMENTED_CURATED_JSONS_0801 = {
    "Transportation/20250516/Transportation_20250516_image_list_keep_0.95_part_8.json",
}
AUGMENTED_CURATED_JSONS_0801 = {pathlib.Path(f"{DATA_CURATION_ROOT}/{x}") for x in AUGMENTED_CURATED_JSONS_0801}
...
def get_dino_coco_folders_and_splits(dino_coco_target_root, augmented_curated_jsons):
    dino_coco_folders =[
       pathlib.Path(dino_coco_target_root) / pathlib.Path(x).stem for x in augmented_curated_jsons
    ]
    dino_coco_splits = []
...
DINO_COCO_FOLDERS_0715, DINO_COCO_SPLITS_0715 = get_dino_coco_folders_and_splits(DINO_COCO_TARGET_ROOT_NEW, AUGMENTED_CURATED_JSONS_0715)
DINO_COCO_FOLDERS_0731, DINO_COCO_SPLITS_0731 = get_dino_coco_folders_and_splits(DINO_COCO_TARGET_ROOT_NEW, AUGMENTED_CURATED_JSONS_0731)
DINO_COCO_FOLDERS_0801, DINO_COCO_SPLITS_0801 = get_dino_coco_folders_and_splits(DINO_COCO_TARGET_ROOT_NEW, AUGMENTED_CURATED_JSONS_0801)
# DINO_COCO_SPLITS_0801 = DINO_COCO_SPLITS_0801[:1] # temporary fix
