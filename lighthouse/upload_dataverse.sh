...
for i in {0..3}; do
    ...
    python import_vqa.py -host https://visionai.linkervision.ai/dataverse/curation -e  julianlee@linkervision.com -p $DATAVERSE_PASSWORD -s 2bd928e5-a98f-4aae-a093-8545c57c103f -project 230 --folder /mnt/data-home/mobility-multimodal/vlm-annotations/Ports_Corporation/20250124/Ports_Corporation_20250124_curated_t17_split${i}/
done

# python import_vqa.py -host https://visionai.linkervision.ai/dataverse/curation -e  julianlee@linkervision.com -p $DATAVERSE_PASSWORD -s 2bd928e5-a98f-4aae-a093-8545c57c103f -project 230 --folder /mnt/data-home/mobility-multimodal/vlm-annotations/Ports_Corporation/20250124/Ports_Corporation_20250124_curated_t17_split0/
