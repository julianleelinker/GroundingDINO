...
def main(scale=2.5, merge_threshold=0.35, plot_mode=False, batch=0):
    ...
    batch_list = [
        [pathlib.Path("/mnt/lighthouseACD/QAed-data/bbox/hand0521/Transportation_20250115_image_list_keep_0.95_rededuplicate/split18_0.30_0.35/")],
        [pathlib.Path("/mnt/lighthouseACD/QAed-data/bbox/hand0521/Transportation_20250115_image_list_keep_0.95_rededuplicate/split16_0.30_0.35/")],
    ]
