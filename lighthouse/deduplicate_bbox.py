...
def main(dry_run=False):
    ...
    except_root = "/mnt/data-home/mobility-multimodal/revised_bbox/datasets"
    slice_root = "/mnt/lighthouseACD/ACD-gdino-COCO"
    new_bbox_root = "/mnt/data-home/mobility-multimodal/revised_bbox/deduplicated"
    ...
    slice_folder_list = [x for x in slice_folder_list if (x/"uploaded").exists()]
    slice_folder_list = [x for x in slice_folder_list if not pathlib.Path(str(x).replace("/mnt/lighthouseACD/ACD-gdino-COCO", except_root)).exists()]
